 ...
 * esquerda-alinhada de cima para baixo (mesa de trabalho, não quadro
 * centralizado). `rodape` é o slot fixo no rodapé do frame, independente do
 * fluxo do conteúdo principal. */
export const Papel: React.FC<{
  children: React.ReactNode;
  rodape?: React.ReactNode;
  style?: React.CSSProperties;
}> = ({ children, rodape, style }) => (
  <AbsoluteFill style={{ backgroundColor: tema.cor.chao }}>
    <AbsoluteFill
      style={{
        padding: tema.espaco.margem,
        // conteúdo que encosta no rodapé (ex.: linhas do Placar com
        // marginTop:auto) precisa de reserva extra aqui - senão a última
        // linha e o slot `rodape` (ambos ancorados no mesmo bottom:margem)
        // colidem no mesmo pixel.
